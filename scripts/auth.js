...
loginForm.addEventListener('submit', (e) => {
    ...
    auth.signInWithEmailAndPassword(email, password).then(cred => {
        ...
        document.getElementById("errorMessageLogin").innerText = err.message; /* Saves error message as a text variable */
    });
});
...
SteamLoginForm.addEventListener('submit', (e) => {
    ...
    auth.signInWithEmailAndPassword(email, password).then(cred => {
        ...
        console.log(err.message);
        document.getElementById("errorMessageLoginSteam").innerText = err.message; /* Saves error message as a text variable */
    });
});
...
/*
    ...
    Listens for when the add offer link is clicked, gets a reference to the 
    form in the modal, gets the offer and request from the form and uses the add
